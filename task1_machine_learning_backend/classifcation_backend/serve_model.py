...
class MultiLabelClassifierPyfunc(object):
    """
    Image classification model with embedded pre-processing.

    This class is essentially an MLflow custom python function wrapper around this specific problem of multi-labelling.
    """
    ...
    def predict(self, input):
        ...
        probs = self._predict_labels(images)
        m, n = probs.shape
